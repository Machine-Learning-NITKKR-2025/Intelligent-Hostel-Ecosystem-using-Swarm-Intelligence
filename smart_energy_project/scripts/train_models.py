...
def train_long_term(df):
    ...
    if dt_col is not None:
        ...
        print("No datetime column found for long-term resampling — creating a synthetic daily index from the row index. Long-term forecasts may be meaningless.")
        df = df.copy()
    ...
    if len(daily) < 30:
        print('Warning: less than 1 daily points after resampling; long-term forecasts will be limited.')
